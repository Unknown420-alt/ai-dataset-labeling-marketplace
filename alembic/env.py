...
from app.core.database import Base, normalize_url
from app import models  # noqa: F401  (register tables so autogenerate sees them)
...
_db_url = normalize_url(
    os.getenv("DIRECT_URL") or os.getenv("DATABASE_URL") or settings.database_url
)
